        ...
        <div>
            <main class="main-content mt-0">
                <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="
                        background-image: url('image/setup_images/1.jpg');
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5 text-center mx-auto">
                                ...
                                <p class="text-lead text-white">
                                    Join us in making your life beautiful by registering on our platform.
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <form @submit.prevent="submit">
                                        ...
                                        <div class="text-center">
                                            <PrimaryButton class="btn bg-gradient-dark w-100 my-4 mb-2" :class="{
                                                'opacity-25':
                                                    form.processing,
                                        ...
                                        <p class="text-sm mt-3 mb-0 text-center">
                                            ...
                                            <Link href="/login"  class="text-dark font-weight-bolder">Sign in</Link>
                                        </p>
                                    </form>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-8 mx-auto text-center mt-1">
                        <p class="mb-0 text-secondary">Copyright ©</p>
                    </div>
                </div>
            </div>
        </footer>
